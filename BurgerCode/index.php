            ...
            foreach($categories as $category)
            {
                if($category['id'] == '1')
                {
                    echo '<li class="active" role="presentation">
                            <a href="#' . $category['id'] . '" class="nav-link active" data-bs-toggle="pill" data-bs-target="#tab' . $category['id'] . '" role="tab">'
                            . $category['name'] . '</a>
                        </li>';
                }
                else{
                    echo '<li role="presentation">
                            <a href="#' . $category['id'] . '" class="nav-link" data-bs-toggle="pill" data-bs-target="#tab' . $category['id'] . '" role="tab">'
                            . $category['name'] . '</a>
                        </li>';
                }
            }
